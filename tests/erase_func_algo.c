...
static struct test_case test_cases[] = {
	{
		...
		.eraseblocks_expected = {{0xe, 0x1}, {0xc, 0x2}, {0x8, 0x4}, {0x0, 0x8}},
		...
		.eraseblocks_expected = {{0x2, 0x1}, {0x4, 0x1}, {0x6, 0x1}, {0x8, 0x1}, {0xa, 0x1}},
		...
		.eraseblocks_expected = {{0x0, 0x4}, {0x8, 0x8}},
		...
		.written_buf =  {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0xff,
				 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8},
		.eraseblocks_expected = {{0x6, 0x1}, {0x4, 0x2}, {0x0, 0x4}, {0x8, 0x8}},
		.eraseblocks_expected_ind = 4,
		...
		.written_buf =  {0xff, 0xff, 0xff, 0xff, 0x1, 0x2, 0x3, 0x4,
				 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		.eraseblocks_expected = {{0x4, 0x1}, {0x5, 0x1}, {0x6, 0x1}, {0x7, 0x1}},
		.eraseblocks_expected_ind = 4,
		...
		.written_buf =  {0x11, 0x22, 0x33, 0x44, 0xff, 0xff, 0xff, 0xff,
				 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8},
		.eraseblocks_expected = {{0x0, 0x1}, {0x1, 0x1}, {0x2, 0x1}, {0x3, 0x1}, {0x8, 0x8}},
		.eraseblocks_expected_ind = 5,
